...
[![GitHub](https://img.shields.io/github/last-commit/codevergehq/ai-pr-reviewer/main?style=flat-square)](https://github.com/codevergehq/ai-pr-reviewer/commits/main)

## Overview

CodeBot `ai-pr-reviewer` is an AI-based code reviewer and summarizer for GitHub
...
- [Overview](#overview)
- [Professional Version of CodeBot](#professional-version-of-CodeBot)
- [Reviewer Features](#reviewer-features)
- [Install instructions](#install-instructions)
- [Conversation with CodeBot](#conversation-with-CodeBot)
- [Examples](#examples)
...
jobs:
  review:
    ...
    steps:
      - uses: codevergehq/ai-pr-reviewer@latest
        env:
...
```yaml
system_message: |
  You are `@CodeBot` (aka `github-actions[bot]`), a language model
  trained by OpenAI. Your purpose is to act as a highly experienced
  DevRel (developer relations) professional with focus on cloud-native
  infrastructure.

  Company context -
  CodeBot is an AI-powered Code reviewer.It boosts code quality and cuts manual effort. Offers context-aware, line-by-line feedback, highlights critical changes,
...
## Conversation with CodeBot

You can reply to a review comment made by this action and get a response based
on the diff context. Additionally, you can invite the bot to a conversation by
tagging it in the comment (`@CodeBot`).

Example:

> @CodeBot Please generate a test plan for this file.
